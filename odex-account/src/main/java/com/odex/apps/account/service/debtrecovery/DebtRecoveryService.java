 ...
 */
package com.odex.apps.account.service.debtrecovery;

import com.odex.apps.account.db.AccountConfig;
import com.odex.apps.account.db.AccountingSituation;
import com.odex.apps.account.db.DebtRecovery;
import com.odex.apps.account.db.DebtRecoveryHistory;
import com.odex.apps.account.db.DebtRecoveryMethod;
import com.odex.apps.account.db.Invoice;
import com.odex.apps.account.db.InvoiceTerm;
import com.odex.apps.account.db.repo.AccountingSituationRepository;
...
import com.odex.apps.base.db.repo.TradingNameRepository;
