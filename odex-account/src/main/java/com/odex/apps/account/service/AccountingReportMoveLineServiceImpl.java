...
import com.odex.apps.account.db.AccountingReportMoveLine;
import com.odex.apps.account.db.PaymentMoveLineDistribution;
import com.odex.apps.account.db.repo.AccountingReportMoveLineRepository;
import com.odex.apps.account.db.repo.AccountingReportRepository;
import com.odex.apps.account.db.repo.PaymentMoveLineDistributionRepository;
...
public class AccountingReportMoveLineServiceImpl implements AccountingReportMoveLineService {
  ...
  public List<String> generateN4DSLines(AccountingReport accountingExport) throws AxelorException {
    ...
    lines.add(setN4DSLine("S10.G01.00.005", "ODEX OPEN SUITE"));
    lines.add(setN4DSLine("S10.G01.00.006", "ODEX"));
