 ...
 */
package com.odex.apps.account.service.custom;

import com.odex.apps.account.db.Account;
import com.odex.apps.account.db.AccountingReport;
import com.odex.apps.account.db.AccountingReportAnalyticConfigLine;
import com.odex.apps.account.db.AccountingReportConfigLine;
import com.odex.apps.account.db.AccountingReportType;
import com.odex.apps.account.db.AccountingReportValue;
import com.odex.apps.account.db.AnalyticAccount;
import com.odex.apps.account.db.repo.AccountRepository;
import com.odex.apps.account.db.repo.AccountingReportAnalyticConfigLineRepository;
import com.odex.apps.account.db.repo.AccountingReportConfigLineRepository;
import com.odex.apps.account.db.repo.AccountingReportRepository;
import com.odex.apps.account.db.repo.AccountingReportTypeRepository;
import com.odex.apps.account.db.repo.AccountingReportValueRepository;
import com.odex.apps.account.db.repo.AnalyticAccountRepository;
...
import com.odex.apps.base.service.DateService;
...
public class AccountingReportValueServiceImpl extends AccountingReportValueAbstractService
  ...
  protected Query<TraceBack> getTracebackQuery(AccountingReport accountingReport) {
    return traceBackRepository
        .all()
        .filter("self.ref = 'com.odex.apps.account.db.AccountingReport' AND self.refId = :id")
