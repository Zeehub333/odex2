...
import com.odex.apps.account.db.Irrecoverable;
import com.odex.apps.account.db.IrrecoverableCustomerLine;
import com.odex.apps.account.db.IrrecoverableInvoiceLine;
import com.odex.apps.account.db.IrrecoverablePaymentScheduleLineLine;
import com.odex.apps.account.db.IrrecoverableReportLine;
import com.odex.apps.account.db.ManagementObject;
import com.odex.apps.account.db.Move;
import com.odex.apps.account.db.MoveLine;
import com.odex.apps.account.db.PaymentSchedule;
...
import com.odex.apps.account.db.repo.IrrecoverableCustomerLineRepository;
import com.odex.apps.account.db.repo.IrrecoverableRepository;
import com.odex.apps.account.db.repo.ManagementObjectRepository;
import com.odex.apps.account.db.repo.MoveLineRepository;
import com.odex.apps.account.db.repo.MoveRepository;
import com.odex.apps.account.db.repo.PaymentScheduleLineRepository;
...
import com.odex.apps.base.db.repo.ExceptionOriginRepository;
