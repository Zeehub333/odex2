...
import com.odex.apps.account.db.InvoiceBatch;
import com.odex.apps.account.db.repo.InvoiceBatchRepository;
import com.odex.apps.account.db.repo.InvoiceRepository;
import com.odex.apps.account.service.invoice.generator.batch.BatchStrategy;
import com.odex.apps.account.service.invoice.generator.batch.BatchValidation;
import com.odex.apps.account.service.invoice.generator.batch.BatchVentilation;
...
public class InvoiceBatchService {
  ...
  public Batch wkf(InvoiceBatch invoiceBatch) throws AxelorException {
    ...
    if (invoiceBatch.getToStatusSelect().equals(InvoiceRepository.STATUS_VALIDATED)) {
      ...
      throw new AxelorException(
          TraceBackRepository.CATEGORY_INCONSISTENCY,
          I18n.get(com.odex.apps.account.exception.AccountExceptionMessage.INVOICE_BATCH_1),
